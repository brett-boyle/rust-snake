...
sourcesIndex["bytemuck"] = {"name":"","files":["allocation.rs","anybitpattern.rs","checked.rs","contiguous.rs","internal.rs","lib.rs","no_uninit.rs","offset_of.rs","pod.rs","pod_in_option.rs","transparent.rs","zeroable.rs","zeroable_in_option.rs"]};
...
sourcesIndex["glutin"] = {"name":"","dirs":[{"name":"api","dirs":[{"name":"egl","files":["make_current_guard.rs","mod.rs"]},{"name":"wgl","files":["make_current_guard.rs","mod.rs"]}],"files":["dlloader.rs","mod.rs"]},{"name":"platform","files":["mod.rs","windows.rs"]},{"name":"platform_impl","dirs":[{"name":"windows","files":["mod.rs"]}],"files":["mod.rs"]}],"files":["context.rs","lib.rs","windowed.rs"]};
sourcesIndex["glutin_egl_sys"] = {"name":"","files":["lib.rs"]};
sourcesIndex["glutin_wgl_sys"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["libloading"] = {"name":"","dirs":[{"name":"os","dirs":[{"name":"windows","files":["mod.rs"]}],"files":["mod.rs"]}],"files":["changelog.rs","error.rs","lib.rs","util.rs"]};
...
sourcesIndex["rust_snake"] = {"name":"","files":["drawing.rs","game.rs","main.rs","snake.rs"]};
...
sourcesIndex["winapi"] = {"name":"","dirs":[{"name":"km","files":["mod.rs"]},{"name":"shared","files":["basetsd.rs","cfg.rs","devpropdef.rs","guiddef.rs","hidusage.rs","in6addr.rs","inaddr.rs","ktmtypes.rs","minwindef.rs","mmreg.rs","mod.rs","mstcpip.rs","ntdef.rs","ntstatus.rs","qos.rs","rpc.rs","rpcdce.rs","rpcndr.rs","windef.rs","windowsx.rs","winerror.rs","ws2def.rs","ws2ipdef.rs","wtypes.rs","wtypesbase.rs"]},{"name":"ucrt","files":["mod.rs"]},{"name":"um","dirs":[{"name":"gl","files":["mod.rs"]}],"files":["cfgmgr32.rs","combaseapi.rs","commctrl.rs","commoncontrols.rs","consoleapi.rs","dwmapi.rs","errhandlingapi.rs","fileapi.rs","handleapi.rs","imm.rs","libloaderapi.rs","minwinbase.rs","mmsystem.rs","mod.rs","oaidl.rs","objbase.rs","objidl.rs","objidlbase.rs","ole2.rs","oleidl.rs","processenv.rs","processthreadsapi.rs","propidl.rs","propkeydef.rs","propsys.rs","reason.rs","shellapi.rs","shellscalingapi.rs","shobjidl_core.rs","shtypes.rs","timeapi.rs","unknwnbase.rs","uxtheme.rs","winbase.rs","wincon.rs","wincontypes.rs","wingdi.rs","winnt.rs","winreg.rs","winsock2.rs","winuser.rs","ws2tcpip.rs"]},{"name":"vc","files":["excpt.rs","limits.rs","mod.rs","vadefs.rs","vcruntime.rs"]},{"name":"winrt","files":["mod.rs"]}],"files":["lib.rs","macros.rs"]};
sourcesIndex["window"] = {"name":"","files":["lib.rs","no_window.rs"]};
sourcesIndex["winit"] = {"name":"","dirs":[{"name":"platform","files":["mod.rs","run_return.rs","windows.rs"]},{"name":"platform_impl","dirs":[{"name":"windows","dirs":[{"name":"event_loop","files":["runner.rs"]}],"files":["dark_mode.rs","dpi.rs","drop_handler.rs","event.rs","event_loop.rs","icon.rs","mod.rs","monitor.rs","raw_input.rs","util.rs","window.rs","window_state.rs"]}],"files":["mod.rs"]}],"files":["dpi.rs","error.rs","event.rs","event_loop.rs","icon.rs","lib.rs","monitor.rs","window.rs"]};
createSourceSidebar();
